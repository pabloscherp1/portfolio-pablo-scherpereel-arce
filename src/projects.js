const projects = [
  {
    ...
    badge: "2026",
    tags: ["Mission Autonomy", "Task Planning", "Receding-Horizon Planning", "Monte Carlo Evaluation", "NASA JPL"],
    brief: "MEXEC-analogous greedy receding-horizon task planner for NASA's Endurance lunar rover, benchmarked against Scripted and Reactive autonomy through full-mission Monte Carlo evaluation.",
    overview: "Endurance is NASA's proposed flagship rover for a 2,600 km traverse across the lunar South Pole-Aitken basin, where sparse communication windows and extreme terrain make ground-directed operations impractical. The rover must autonomously schedule drives, science sampling, downlinks and thermal management over multi-day horizons within tight power and data constraints.\n\nThis Master's thesis at NASA JPL implements a MEXEC-analogous autonomy layer in MATLAB within MissionSim, JPL's mission-level Monte Carlo simulation of the Endurance traverse. The core contribution is a greedy receding-horizon task planner that reinterprets Endurance's baseline onboard planner at mission scale: a priority-ordered scheduler that projects power, data and thermal resource timelines across a multi-day horizon and places each task at its earliest feasible slot. The planner runs a full observe, plan, commit, execute and replan loop, replanning on task completion, fault detection or projected resource violations. To support it, the thesis extends MissionSim's power, data, thermal and fault models.\n\nFive autonomy configurations across the Scripted, Reactive and Proactive families are benchmarked through full-mission Monte Carlo evaluation: Scripted, Reactive-fixed, Reactive-lookup, Proactive-baseline (the greedy planner) and Proactive-stretch (the baseline plus onboard fault recovery, the autonomy level expected for Endurance). Edge-case studies isolate the mission conditions under which proactive scheduling pays off over reactive control, and the resulting comparison informs JPL's V&V investment in flight-certifying the onboard autonomy stack. The work is being written up as a lead-author paper for the AIAA SciTech Forum 2027, for which the extended abstract has been accepted.",
    skills: ["Mission Autonomy", "Task Planning", "Receding-Horizon Planning", "Resource Timeline Modelling", "Monte Carlo Evaluation", "MEXEC Architecture", "Fault Management", "MATLAB"],
    cardSkills: ["Mission Autonomy", "Task Planning", "Receding-Horizon Planning", "Monte Carlo Evaluation", "Fault Management", "MATLAB"],
    keyDetails: [
      { label: "Role", value: "Graduate Visiting Student Researcher (Master's Thesis)" },
      { label: "Period", value: "April – November 2026" },
      { label: "Supervisors", value: "Dr. Saptarshi Bandyopadhyay (JPL) · Prof. Stefan Leutenegger · Dr. Matteo Iovino · Prof. Richard Kornfeld (ETH)" },
      { label: "Program", value: "Endurance Lunar Rover · NASA JPL" },
      { label: "Publication", value: "AIAA SciTech Forum 2027 · lead author, extended abstract accepted" }
    ],
  ...
  },
  {
    ...
    overview: "Hermes is ARIS's (ETH Rocket Team) first bi-liquid sounding rocket, a 5.4 m supersonic vehicle with over 50 engineers across propulsion, structures, avionics and recovery. A bi-propellant liquid system introduces safety-critical complexity in propellant management, feed system design and ignition sequencing that demands rigorous systems-level coordination.\n\nAs Chief Engineer, my responsibilities ran across systems engineering, field operations and programme management throughout Hermes's development lifecycle. On the engineering side, I worked on the top-level system requirements, owned cross-subsystem interface definitions and drove technical documentation standards; alongside the other SEs I built the full V&V plan, sequencing qualification campaigns from component level through sub-assembly acceptance up to full-vehicle readiness. That plan translated into direct field involvement: I helped conducting pressurization tests on the assembled Propellant Supply System, served as test conductor for multiple torch igniter fine-tuning tests and led structural and composite manufacturing qualification campaigns, with the Assembly Lead role through integration and launchpad operations. In parallel I carried the programme management workpackages: chairing all technical reviews, managing budgets, timeline and managing stakeholder relations with our external partners.",
    ...
    cardSkills: ["Systems Engineering", "Project Management", "Requirements Engineering", "Verification Planning", "Bi-Liquid Propulsion", "Test Operations"],
    keyDetails: [
  ...
  },
  {
    ...
    brief: "End-to-end MATLAB simulator for a Pre-Phase A study of a formation-flying optical interferometer at Sun-Earth L2.",
    overview: "Combining light from telescopes flying in formation gives an interferometer an angular resolution set by the baseline between spacecraft rather than by any single aperture, but it makes the science sensitive to optical path differences from centimetres down to below a millimetre. This was a Pre-Phase A concept study (NASA's earliest feasibility stage) of a space-based interferometric constellation for exoplanet imaging and astrometry, following the heritage of SIM and TPF-I: two collector telescopes and a beam combiner flying in formation on a Sun-Earth L2 halo orbit, with baselines of 50 to 5,000 m.\n\nI contributed to the study as sole developer of its end-to-end, low-fidelity MATLAB simulator. It generates CR3BP halo orbits and propagates the formation under lunar perturbation from SPICE ephemerides with periodic station-keeping. During observations it controls the geometric delay line with a cancellation burn followed by continuous electrospray thrusting inside a tolerance box. Each spacecraft's attitude is tracked on SO(3) under gravity-gradient and solar radiation pressure torques with a feedforward PD controller, and a least-squares thruster allocation turns the commanded torques into per-target impulse budgets.\n\nOn top of the dynamics sit field-of-regard and delta-v optimized observation schedulers, which place each target at its best zero-delay-line opportunity over a full solar orbit. Trading delay-line tolerance, field of regard and baseline against delta-v and mission duration gave preliminary L1/L2 requirements on relative navigation accuracy, control authority and metrology precision, along with early bounds on mission length and delta-v budgets.",
    skills: ["GNC", "Orbital Dynamics", "Interferometry", "Requirements Definition", "ITM Analysis", "Attitude Control", "MATLAB"],
    cardSkills: ["GNC", "Orbital Dynamics", "Interferometry", "Requirements Definition", "MATLAB"],
    keyDetails: [
    ...
    galleryImages: ["media/03/03-dynamicsim.png", "media/03/03-halo-orbit.png", "media/03/03-visia-formation.gif"],
  ...
  },
  {
    ...
    cardSkills: ["Cold-Gas RCS", "ADCS", "Bang-Bang Control", "Simulink", "Systems Engineering"],
    keyDetails: [
  ...
  },
  {
    ...
    cardSkills: ["Compressible Flow", "Nozzle Design", "FEA", "CFD", "Structural Design"],
    keyDetails: [
  ...
  },
  {
    ...
    cardSkills: ["Structural Design", "FEA", "Additive Manufacturing", "Topology Optimization", "ANSYS"],
    keyDetails: [
  ...
  },
  {
    ...
    cardSkills: ["Structural Design", "3D Printing", "SolidWorks", "CFRP Lamination", "FEA"],
    keyDetails: [
      { label: "Role", value: "Structural Engineer" },
  ...
  },
  {
    ...
    cardSkills: ["FEA", "Mesh Convergence", "Stress Analysis", "Abaqus CAE"],
    keyDetails: [
  ...
  },
  {
    ...
    cardSkills: ["Sensor Fusion", "FFT Analysis", "Thermal Modelling", "Arduino"],
    keyDetails: [
  ...
  },
  {
    ...
    cardSkills: ["Mechanism Design", "SolidWorks", "FDM Manufacturing", "Prototype Development"],
    keyDetails: [
  ...
  },
  {
    ...
    cardSkills: ["Product Design", "Mechanism Design", "SolidWorks", "Prototype Development"],
    keyDetails: [
